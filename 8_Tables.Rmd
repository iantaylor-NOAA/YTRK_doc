...
```{r, results = 'asis'}
    ...
    Sens_model2 = Sens_model2[ , 1:10]
    # Create sensitivities table
    Sens_model2.table = xtable(Sens_model2, 
                               caption = c('Sensitivity of the Southern to a variety of alternative assumptions (first of two tables).'),
...
```{r, results = 'asis'}
    ...
    # Read in/organize sensitivity file, change column names, caption
    Sens_model2 = read.csv('./txt_files/parameter_comparison_table.SOUTH.csv')
    Sens_model2 = Sens_model2[ , c(1:2, 11:17)]

    # Create sensitivities table
    Sens_model2.table = xtable(Sens_model2, 
                               caption = c('Sensitivity of the Southern to a variety of alternative assumptions (second of two tables).'),
