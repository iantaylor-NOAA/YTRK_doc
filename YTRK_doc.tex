...
\begin{figure}[htbp]
\centering
\includegraphics{YTRK_doc_files/figure-latex/unnamed-chunk-2-1.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{YTRK_doc_files/figure-latex/unnamed-chunk-3-1.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{YTRK_doc_files/figure-latex/unnamed-chunk-4-1.pdf}
\caption{Stacked line plot of Yellowtail rockfish landings history for
...
\begin{tabular}{rr>{\centering}p{1.1in}>{\centering}p{1.1in}>{\centering}p{1.1in}>{\centering}p{1.1in}>{\centering}p{1.1in}>{\centering}p{1.1in}>{\centering}p{1.1in}>{\centering}p{1.1in}>{\centering}p{1.1in}>{\centering}p{1.1in}}
  \hline
Model Region & Quantity & 2006 & 2007 & 2008 & 2009 & 2010 & 2011 & 2012 & 2013 & 2014 & 2015 \\ 
  \hline
 & Landings (mt) &  &  &  &  &  &  &  &  &  &  \\ 
   & Total Est. Catch (mt) &  &  &  &  &  &  &  &  &  &  \\ 
   & OFL (mt) &  &  &  &  &  &  &  &  &  &  \\ 
   & ACL (mt) &  &  &  &  &  &  &  &  &  &  \\ 
   \hline
Model 1 & (1-$SPR$)(1-$SPR_{50\%}$) & 0.39 & 0.47 & 0.50 & 0.45 & 0.56 & 0.51 & 0.48 & 0.53 & 0.48 &  \\ 
  Base Case & Exploitation rate & 0.28 & 0.35 & 0.38 & 0.33 & 0.44 & 0.39 & 0.35 & 0.41 & 0.36 &  \\ 
   ...
   \hline
Model 2 & (1-$SPR$)(1-$SPR_{50\%}$) & 0.39 & 0.47 & 0.50 & 0.45 & 0.56 & 0.51 & 0.48 & 0.53 & 0.48 &  \\ 
  Base Case & Exploitation rate & 0.28 & 0.35 & 0.38 & 0.33 & 0.44 & 0.39 & 0.35 & 0.41 & 0.36 &  \\ 
   & Age 1+ biomass (mt) & 182.15 & 182.55 & 183.26 & 183.36 & 183.25 & 183.49 & 182.90 & 182.72 & 182.82 & 182.52 \\ 
