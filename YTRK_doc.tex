...
Selectivities in the Northern model (Figure \ref{fig:selex_model1})
shows the difference between the recreational fisheries and the
commercial fishery and survey sampling. All of the fish are fully
selected by 50 cm, but the recreational fish are fully selected at 30
cm.

Retention by length (Figure \ref{fig: retention_model1}) varies over
time between 40\% and 100\%, with no clear pattern of interannual
variation, except for the trawl-rationalization era 2011-present.

Discarding in the commercial fleet (Figure
\ref{fig:r4ss_discard_model1}) is fit only by putting blocks on
...
Commercial length comps are very well fit (Figures \ref{fig:xxx} and
\ref{fig:mod1_5_comp_lenfit_data_weighting_xxx}). Commercial discards
are noiser and not well fit (Figure \ref{fig:mod1_6_comp_lenfxxx}). The
panel describing the combined fits and data weighting for the commercial
...
the data well (Figure \ref{fig:mod1_10_comp_xxx}). Figure
