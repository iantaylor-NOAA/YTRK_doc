...
##Reference Points{-}
\hl{This section yet to be completed}
...
target, and also `r ifelse(Deplete_mod1[nrow(Deplete_mod1),2]-MSST>0,"above","below")` 
...
the biomass target, as well as `r if(n_models>=2){ifelse(Deplete_mod2[nrow(Deplete_mod2),2]-MSST>0,"above","below")}` 
