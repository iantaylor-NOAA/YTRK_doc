...
No estimate of spawning output from the Southern model is available.
...
![Estimated relative depletion with approximate 95\% asymptotic confidance intervals (dashed lines) for the base case assessment model. \label{fig:RelDeplete_all}](`r Bratio.file`)
...
Estimated equilibrium yield curves for the Northern model is shown in Figure \ref{fig:Yield_all}.
