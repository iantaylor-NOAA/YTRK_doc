...
The expanded table detailing the length data is Table \ref{tab:Northern_length}.
...
The expanded table detailing the ages can be found in Table \ref{Northern_age}
...
The expanded table with detailed lengths is Table \ref{Southern_length}
...
The expanded table with detailed age information is Table \ref{Southern_Age}
