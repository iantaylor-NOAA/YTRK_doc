...
The commercial trawl index used the species composition of catch to infer the potential for Yellowtail Rockfish in each haul, however the way in which market categories were changing throughout the period of interest made the species composition of catch unreliable (Theresa Tsou, pers. comm.). The Hake fishery was explained to have had greater heterogeneity among the boats used in the fishery than had been assumed in developing the index (Dan Waldeck, pers. comm.).
