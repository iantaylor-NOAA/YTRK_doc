...
-30    15   -15.817     0     1     0   -1    0    0    0    0    0    0    0  #  LnQ_Small_Fish_Study
#
...
10 0 0 0 # 5 RecStudy
#
20    55    30.201     0    99     0  1  0  0  0  0  0  0  0  #  SizeSel_P1_RecreationalCatch(1)
 -20    20    20     0    99     0     -4  0  0  0  0  0  0  0  #  SizeSel_P2_RecreationalCatch(1)
  -5    20   3.55447     0    99     0  3  0  0  0  0  0  0  0  #  SizeSel_P3_RecreationalCatch(1)
...
-999    25  -999     0    99     0    -99  0  0  0  0  0  0  0  #  SizeSel_P6_RecreationalCatch(1)
 ...
 -20    20    20     0    99     0     -4  0  0  0  0  0  0  0  #  SizeSel_P2_CommercialCatch(2)
  -5    20    5.2631     0    99     0  3  0  0  0  0  0  0  0  #  SizeSel_P3_CommercialCatch(2)
...
-999    25  -999     0    99     0    -99  0  0  0  0  0  0  0  #  SizeSel_P6_CommercialCatch(2)
  20    55   30.2914     0    99     0  1  0  0  0  0  0  0  0  #  SizeSel_P1_OnboardSurvey(3)
 -20     7   -20     0    99     0     -4  0  0  0  0  0  0  0  #  SizeSel_P2_OnboardSurvey(3)
  -5    20   3.54627     0    99     0  3  0  0  0  0  0  0  0  #  SizeSel_P3_OnboardSurvey(3)
  -5    20   7.91106     0    99     0  4  0  0  0  0  0  0  0  #  SizeSel_P4_OnboardSurvey(3)
...
-999    25  -999     0    99     0    -99  0  0  0  0  0  0  0  #  SizeSel_P6_OnboardSurvey(3)
  20    55   47.9691     0    99     0  1  0  0  0  0  0  0  0  #  SizeSel_P1_HookAndLineSurvey(4)
 -20    20    20     0    99     0     -4  0  0  0  0  0  0  0  #  SizeSel_P2_HookAndLineSurvey(4)
  -5    20   5.13065     0    99     0  3  0  0  0  0  0  0  0  #  SizeSel_P3_HookAndLineSurvey(4)
...
-999    25  -999     0    99     0    -99  0  0  0  0  0  0  0  #  SizeSel_P6_HookAndLineSurvey(4)
  20    55    49.124     0    99     0  1  0  0  0  0  0  0  0  #  SizeSel_P1_RecStudy(5)
 -20    20    20     0    99     0     -4  0  0  0  0  0  0  0  #  SizeSel_P2_RecStudy(5)
  -5    20   5.34296     0    99     0  3  0  0  0  0  0  0  0  #  SizeSel_P3_RecStudy(5)
  -5    20    20     0    99     0     -4  0  0  0  0  0  0  0  #  SizeSel_P4_RecStudy(5)
-999    25  -999     0    99     0    -99  0  0  0  0  0  0  0  #  SizeSel_P5_RecStudy(5)
-999    25  -999     0    99     0    -99  0  0  0  0  0  0  0  #  SizeSel_P6_RecStudy(5)
#
#
#
#
...
4 1 0.004255 # 0.004518 0.004255 0.016144 0.941808 3.573368 len RecreationalCatch 
4 2 0.317319 # 0.306952 0.317319 0.487048 1.033775 1.586723 len CommercialCatch 
4 3 0.003935 # 0.004079 0.003935 0.006097 0.964706 1.494771 len OnboardSurvey 
4 4 0.958017 # 0.983092 0.958017 2.049982 0.974494 2.085239 len HookAndLineSurvey 
4 5 0.686709 # 0.632519 0.686709 1.036285 1.085673 1.638346 len RecStudy 
5 1 0.059082 # 0.065085 0.059082 0.331402 0.907774 5.09183 age RecreationalCatch 
5 2 0.1169 # 0.136786 0.1169 0.212324 0.854621 1.552233 age CommercialCatch 
5 4 0.205322 # 0.21157 NA 0.205322 NA 0.97047 age HookAndLineSurvey No Francis weight--using MI value
#
#
-9999   1       0.000000000
#
