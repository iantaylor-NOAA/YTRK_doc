...
# nk  dev_minyr  dev_maxyr  dev_PH  Block  Block_Fxn
  0.02  0.25  0.149      -2.12  0.438  0        -2  0  0  0  0  0  0  0  # 
#  NatM_p_1_Fem_GP_1
...
#  Eggs_exp_len_Fem
  ...
  #_Males
  #
  -3    3    -0.142        0       99  6        -2  0  0  0  0  0  0  0  # 
#  NatM_p_1_Mal_GP_1
...
# R_BH_steep
 0.5  1.2 0.85      0.76  99 0   -6        0   0   0   0   0   0   0 # SR_s
# igmaR
...
# atch(1)
  -30   15   -10.9298    0 1 0  1 0 0 0 0 0 2 2  #  LnQ_base_OnboardSurvey(
# 3)
...
# h(1)_BLK3repl_1993
  -30   15   -12.9157    0    1      0       1  # LnQ_base_OnboardSurvey(3)
# _BLK2repl_1999
#
#_size_selex_types
#
...
-999   25   -999       0   99    0  -99    0    0    0    0    0    0    0 
 ...
 20    55    55        0   99    0   -1    0    0    0    0    0    0    0 
...
-999   25   -999       0   99    0  -99    0    0    0    0    0    0    0 
 ...
 20    55    30.6644   0   99    0    1    0    0    0    0    0    2    2 
 #  SizeSel_P1_OnboardSurvey(3)
-20     7   -20        0   99    0   -4    0    0    0    0    0    0    0 
 #  SizeSel_P2_OnboardSurvey(3)
-5     20     3.31382  0   99    0    3    0    0    0    0    0    2    2 
 #  SizeSel_P3_OnboardSurvey(3)
-5     20    19.9902   0   99    0    4    0    0    0    0    0    2    2 
 #  SizeSel_P4_OnboardSurvey(3)
-999   25   -999       0   99    0  -99    0    0    0    0    0    0    0 
 #  SizeSel_P5_OnboardSurvey(3)
-999   25   -999       0   99    0  -99    0    0    0    0    0    0    0 
 #  SizeSel_P6_OnboardSurvey(3)
 20    55    48.1678   0   99    0    1    0    0    0    0    0    0    0 
 #  SizeSel_P1_HookAndLineSurvey(4)
-20    20    20        0   99    0   -4    0    0    0    0    0    0    0 
 #  SizeSel_P2_HookAndLineSurvey(4)
-5     20     5.13638  0   99    0    3    0    0    0    0    0    0    0 
 #  SizeSel_P3_HookAndLineSurvey(4)
-5     20    20        0   99    0   -4    0    0    0    0    0    0    0 
 #  SizeSel_P4_HookAndLineSurvey(4)
-999   25   -999       0   99    0  -99    0    0    0    0    0    0    0 
 #  SizeSel_P5_HookAndLineSurvey(4)
-999   25   -999       0   99    0  -99    0    0    0    0    0    0    0 
 #  SizeSel_P6_HookAndLineSurvey(4)
 20    55    46.7886   0   99    0    1    0    0    0    0    0    0    0 
 #  SizeSel_P1_SmallFish(6)
-20    20    20        0   99    0   -4    0    0    0    0    0    0    0 
 #  SizeSel_P2_SmallFish(6)
-5     20     5.19586  0   99    0    3    0    0    0    0    0    0    0 
 #  SizeSel_P3_SmallFish(6)
-5     20    20        0   99    0   -4    0    0    0    0    0    0    0 
 #  SizeSel_P4_SmallFish(6)
-999   25   -999       0   99    0  -99    0    0    0    0    0    0    0 
 #  SizeSel_P5_SmallFish(6)
-999   25   -999       0   99    0  -99    0    0    0    0    0    0    0 
 #  SizeSel_P6_SmallFish(6)
#
#_Age_selex for Juvenile Pelagic Survey
#
 0     40     0        5   99    0   -1    0    0    0    0    0    0    0 
 #  AgeSel_P1_JuvenilePelagic(5)
 0     40     0        6   99    0   -1    0    0    0    0    0    0    0 
 #  AgeSel_P2_JuvenilePelagic(5)
...
# P3_RecreationalCatch(1)_BLK3repl_1993
  20       55       30.3874        0       99        0      1    # SizeSel_
# P1_OnboardSurvey(3)_BLK2repl_1999
 -5        20       4.35595        0       99        0      3    # SizeSel_
# P3_OnboardSurvey(3)_BLK2repl_1999
 -5        20       3.07634        0       99        0      4    # SizeSel_
# P4_OnboardSurvey(3)_BLK2repl_1999
#
#
