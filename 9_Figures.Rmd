...
![Time series of relative spawning output estimated in the subset of sensitivity analyses for the `r mod2_label` related to removing indices of abundance from the model. \label{fig:sens_S_Other}](Figures/South_Sens/CPUE.png)
