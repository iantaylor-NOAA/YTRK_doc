...
![Estimated selectivity by length by each fishery and survey in the `r mod1_label`. \label{fig:selex.N}](r4ss/plots_mod1/sel01_multiple_fleets_length1.png)
...
![Estimated density from the VAST model for the NWFSC shelf-slope trawl survey.\label{fig:VAST_Dens_NWFSCcombo}](Figures/VAST_NWFSCcombo/VAST_output_N_lognormal/Dens.png)

![Quantile-Quantile plot for the VAST model with a log-normal error distribution applied to the NWFSC shelf-slope trawl survey in the Northern area.\label{fig:VAST_QQ_NWFSCcombo}](Figures/VAST_NWFSCcombo/VAST_output_N_lognormal/Q-Q_plot.jpg)

![Quantile-Quantile plot for the VAST model with a gamma error distribution applied to the NWFSC shelf-slope trawl survey.\label{fig:VAST_QQ_NWFSCcombo_gamma}](Figures/VAST_NWFSCcombo/VAST_output_N_gamma/Q-Q_plot.jpg)
...
![Quantile-Quantile plot for the MRFSS model with a lognormal error distribution applied to California dockside survey data.
\label{fig:MRFSSlognormal}(Figures/MRFSS_CPUE/GLMdiagnosticslognormalMRFSS.png)

![Quantile-Quantile plot for the MRFSS model with a lognormal error distribution applied to California dockside survey data.
\label{fig:MRFSSgamma}(Figures/MRFSS_CPUE/GLMdiagnosticsgammaMRFSS.png)
...
![Estimated selectivity by length by each fishery and survey in the `r mod2_label`. \label{fig:selex.S}](r4ss/plots_mod2/sel01_multiple_fleets_length1.png)
